...
import com.marouane.library.mappers.BookMapper;
import com.marouane.library.projections.BookSummary;
import com.marouane.library.services.BookService;
...
public class BookController {
    ...
    @DeleteMapping( "/{isbn}" )
    public ResponseEntity<Void> deleteItem( @PathVariable("isbn") String isbn ) {
